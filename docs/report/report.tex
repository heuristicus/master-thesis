...
data set that we have consists of 89 clouds of a single room, taken at different
times during different days of approximately a month of time. The clouds are
made up of a number of intermediate frames, which are merged into a complete
cloud using standard registration methods. The cloud provides a view of the room
which does not include most of the ceiling.
...
Downsampling with this resolution gives a reduction in size of the clouds of
on average 
