...
In this report, we will describe our approach to a small sub-problem of
searching in point clouds known as object query. As the name suggests, this is
the problem of retrieving from a data set objects that are similar to some
object that we have provided. All data is in the form of point clouds, which
store 3D positions of points that represent parts of a surface, along with the
colour at the point.
