...
\begin{figure}
  \centering
  \subfloat[0.01m]{\includegraphics[width=0.8\textwidth]{images/exp_interest_points}}\\
  ...
  \caption{Number of points extracted from clouds by different methods relative
    to the number of points in the cloud. The anomalies from the uniform
    extraction come from the fact that it does not exclude lone points, while
    other methods do. Subcaption indicates downsample leaf size.}
  \label{fig:interest_points}
\end{figure}
\begin{figure}
  \centering
  \subfloat[Scene clouds]{\includegraphics[width=0.49\textwidth]{images/interest_agg}}
  \subfloat[Annotation clouds]{\includegraphics[width=0.49\textwidth]{images/interest_agg_annot}}
  \caption{Time taken for interest point extraction for different numbers of
    ...
    All clouds downsampled with 0.01 leaf size. Each point indicates the time to
    compute interest points for a single cloud.}
  \label{fig:interest_agg}
\end{figure}
\begin{figure}
  \centering
  \subfloat[SHOT family]{\includegraphics[width=0.49\textwidth]{images/feature_agg_shot}}
  \subfloat[PFH family]{\includegraphics[width=0.49\textwidth]{images/feature_agg_pfh}}
  \caption{Computation time for each feature type in relation to number of
    interest points. All clouds downsampled with 0.01 leaf size.}
