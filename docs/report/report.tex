...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{images/orig_transformed}
...
In this step, normals are computed for each point in the cloud. The normal at a
...
\begin{table}
  ...
  \centerline{
    \begin{tabular}{c|cccccc}
      &loadtime & downsample time & trim time & normals time & plane time & per plane time \\\hline
