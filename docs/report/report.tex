...
\begin{table}
  ...
  \centerline{
    \begin{tabular}{cc|ccccccc}
      ...
      \multirow{2}{*}{K10R25}&DEF&12.2$\pm$16.6 & 40.2$\pm$33.4 & 4.5$\pm$6.1 & 10.7$\pm$11.1 & 3.0$\pm$3.5 & 3.4$\pm$3.1 & 0.1$\pm$0.2\\
...
\begin{table}
  ...
  \centerline{
    \begin{tabular}{cc|ccccccc}
      ...
      \multirow{2}{*}{K10R25}&DEF&20.6$\pm$22.1 & 44.5$\pm$34.9 & 4.3$\pm$7.3 & 12.0$\pm$12.0 & 3.6$\pm$4.0 & 5.0$\pm$4.0 & 0.0$\pm$0.0\\
...
\begin{table}
  ...
  \caption{Matching results for the DEF setting for query using data generated
    ...
    selection methods. Top indicates the number of matches which were the top
    cluster, total the total number of matches, and unique the number of target
    clouds in whichmatches were found.}
...
\label{tab:qchair1_k10}
\end{table}

% \begin{table}
%   \begin{tabular}{cc|cccc}
%     Object & Type & Top & Total & Unique & Actual \\\hline
%     \multirow{5}{*}{Backpack} & FPFH & 2.7$\pm$1.5 & 13.0$\pm$14.8 & 13.0$\pm$14.8 & 80.0$\pm$0.0\\
