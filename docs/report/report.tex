...
\begin{figure}
  \centering
  \centerline{
    \subfloat[Default]{\includegraphics[width=0.45\textwidth]{images/int/iss_def}}
    \subfloat[$n_{\min}=12$]{\includegraphics[width=0.45\textwidth]{images/int/iss_def_minn12}}
    \subfloat[$r_s=12R$]{\includegraphics[width=0.45\textwidth]{images/int/iss_sal12}}\\
  }
  \centerline{
    \subfloat[$r_s=12R,\, r_n=8R$]{\includegraphics[width=0.45\textwidth]{images/int/iss_sal12_nm8}}
    \subfloat[$r_s=12R,\, r_n=8R,\, n_{\min}=10 $]{\includegraphics[width=0.45\textwidth]{images/int/iss_sal12_nm8_minn10}}
    \subfloat[$r_s=4R,\, n_{\min}=2$]{\includegraphics[width=0.45\textwidth]{images/int/iss_sal4_nm2}}
  }
...
\begin{figure}
  \centering
  \centerline{
    \subfloat[Default]{\includegraphics[width=0.45\textwidth]{images/int/sift_ms0_04}}
    \subfloat[$S_{\min}=0.01$]{\includegraphics[width=0.45\textwidth]{images/int/sift_ms0_01}}
    \subfloat[$S_{\min}=0.02$]{\includegraphics[width=0.45\textwidth]{images/int/sift_ms0_02}}\\
  }
  \centerline{
    \subfloat[$S_{\min}=0.03$]{\includegraphics[width=0.45\textwidth]{images/int/sift_ms0_03}}
    \subfloat[$S_{\min}=0.03,\, o=2$]{\includegraphics[width=0.45\textwidth]{images/int/sift_ms0_03_oc2}}
    \subfloat[$S_{\min}=0.03,\, o_s=3$]{\includegraphics[width=0.45\textwidth]{images/int/sift_ms0_03_os3}}
  }
