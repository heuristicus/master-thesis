...
\begin{figure}
  \centering
  \includegraphics[width=0.49\textwidth]{images/trimmed_side}
  \includegraphics[width=0.49\textwidth]{images/trimmed_top}
  \includegraphics[width=0.49\textwidth]{images/trimmed_diag_left}
  \includegraphics[width=0.49\textwidth]{images/trimmed_diag_right}
...
the system, including by feature selection methods and features. They are also
used in the plane extraction step to increase accuracy.
...
\begin{figure}
  ...
  \caption{Example of the smoothing effect of normal computation radius. From
    bottom to top, 0.01, 0.025, 0.5, 0.2, 0.25, 0.5cm radius. Normals are
    indicated by orange lines. Note the tendency of normals with higher radius to
    tilt as they approach the corner. Normals on the top section are slightly
    skewed due to perspective.}
  \label{fig:normal_corner}
\end{figure}

Normal and plane extraction section order
depends partly on the order in which it is done. Talk about how normal
extraction can help with plane extraction, if I do that.
